...
window.onload = function() {
  ...
  document.getElementById('ws-info-display').appendChild(Game.getDisplay('info').getContainer());
  document.getElementById('ws-messages-display').appendChild(Game.getDisplay('message').getContainer());
